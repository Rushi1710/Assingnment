...
<body>
	...
	<!-- <div class="w3-container">
		<h2 style="color: red; font-style: normal; align-content: center;">Admin
			Page</h2>
		<div class="w3-responsive">
			<table class="w3-table-all">
				...
				<tr>
					...
					<td></td>
					<td></td>
					<td><img class="" src="" alt="Card image cap" width="200px"
						height="200px"></td>
					<td><button onclick="deleteIteam()">Delete Iteam</button></td>
				</tr>
			</table>
		</div>
	</div> -->
	...
	<table class="table table-primary table-hover my-3 table-bordered"
		...
		<tbody>
			...
			<tr>
				...
				<td><img src="../productimages/<%=p.getImage()%>" style="height: 60px"
					width="60px" class="img-fluid img-thumbnail" alt="Sheep"></td>
				<td><button type="button" class="btn btn-success"
						data-bs-toggle="modal" data-bs-target="#update-product-modal"
						onclick="updateProduct(<%=p.getProductId()%>)">Update</button></td>
				<td><button type="button" class="btn btn-danger"
						onclick="deleteProduct(<%=p.getProductId()%>)">Delete</button></td>
			</tr>
